...
A simple and elegant household chore management application built with Ruby and Sinatra. It provides a visual interface for family members to see and complete their assigned tasks, and a separate administrative area for managing the household.
